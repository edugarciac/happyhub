  ...
  return (
    <Html lang="es">
      <Head>
        ...
        <link rel="icon" type="image/jpeg" href="/logo-happyhub-white smal.jpeg" />
        <link rel="shortcut icon" type="image/jpeg" href="/logo-happyhub-white smal.jpeg" />
        <link rel="apple-touch-icon" href="/logo-happyhub-white smal.jpeg" />
        ...
        <meta property="og:image" content="/logo-happyhub-white smal.jpeg" />
      </Head>
      <body>
        <Main />
        <NextScript />
