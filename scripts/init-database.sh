...
# Initialize HappyHub database
# This script creates the database schema and seed data

set -e

echo "🗄️  Initializing HappyHub database..."
...
echo ""
echo "Demo users (password: happyhub123):"
echo "  - admin@happyhub.es (Admin)"
echo "  - cliente@happyhub.es (Client)"
echo "  - proveedor@happyhub.es (Provider)"
echo ""
